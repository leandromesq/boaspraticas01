...
public class NPCloja extends NPCs
{
    ...
    NPCloja(String nome){
        ...
        falas = new ArrayList<String>(){{
                add("Bem vindo à minha loja, eu sou Remi, o rato, o que você está procurando hoje?");
            }};
    ...
    public void steal(ArrayList<Itens> c){
        System.out.println("O que você acha que está fazendo? Não tente me roubar, mais respeito ao rato!. \n");
    }
